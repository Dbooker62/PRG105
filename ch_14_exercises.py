...
dogs_cursor.execute("""INSERT INTO Dogs (DogID, DogName, OwnerName, Breed)
                    VALUES (1, "Donovan", "Ben", "Golden Retriever")""")
dogs_cursor.execute("""INSERT INTO Dogs (DogID, DogName, OwnerName, Breed)
                    VALUES (2, "Buddy", "Mary", "Labrador Retriever")""")
dogs_cursor.execute("""INSERT INTO Dogs (DogID, DogName, OwnerName, Breed)
                    VALUES (3, "Lucy", "John", "Beagle")""")
dogs_cursor.execute("""INSERT INTO Dogs (DogID, DogName, OwnerName, Breed)
                    VALUES (4, "Charlie", "Emily", "Poodle")""")
...
dogs_cursor.execute("""SELECT * FROM Dogs WHERE DogID=2""")
updated_record = dogs_cursor.fetchone()
