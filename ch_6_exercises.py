...
line1 = states_data.readline().strip()
line2 = states_data.readline().strip()
line3 = states_data.readline().strip()
...
for i in range(1, books + 1):
    title = input("Enter the title of book {}: ".format(i))
    author = input("Enter the author of book {}: ".format(i))
