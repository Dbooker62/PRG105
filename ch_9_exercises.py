...
birthdays['John'] = 'January 10'
birthdays['Alex'] = 'September 22'
birthdays['Sarah'] ='November 30'
# 2) Use the key to retrieve and print Meri's Birthday
meri_birthday = birthdays['Meri']
print("Meri's Birthday:", meri_birthday)
...
print(list(miles_ridden.values()))
# 5) Use the keys method to print all keys in miles_ridden
print(list(miles_ridden.keys()))
...
num_elements = len(days)
print("Number of elements in days set:", num_elements)
